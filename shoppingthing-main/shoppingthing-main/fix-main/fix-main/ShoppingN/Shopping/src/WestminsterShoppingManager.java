    ...
    public void remove() {
        ...
        for(int i=0;i<ListOfProducts.size();i++){
            if(ProductR.equals(ListOfProducts.get(i).getProductID())){
                ...
                System.out.println("Total number of products: "+getListOfProducts().size());
                removed = true;
    ...
    public Product getInput(){
       ...
       String productID = "";
        while (productID.isEmpty()) {
            ...
            if (productID.isEmpty()) {
                System.out.println("Product ID cannot be empty. Please re-enter a ID.");
            }
        }
       ...
       while (productName.isEmpty()) {
           ...
           if (productName.isEmpty()) {
               System.out.println("Product name cannot be empty. Please re-enter a name.");
           }
       }
